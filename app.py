...
# st.set_page_config(
#     page_title="Twitter/X Social Listening",
#     layout="wide"
# )
...
#     if not BEARER_TOKEN:
#         st.error("Please enter Bearer Token")
#         st.stop()
...
#                 "Tweet URL":
#                 f"https://twitter.com/{author.get('username')}/status/{tweet['id']}"
...
st.set_page_config(
    page_title="Free Twitter/X Scraper",
    layout="wide"
)

st.title("🐦 Free Twitter/X Scraper")
